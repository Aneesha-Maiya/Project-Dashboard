...
export default function AddTasksForm(props) {
  ...
  return (
        <Form noValidate onSubmit={
            ...
            (data)=>{
                console.log(data)
                props.changeTasksList(data.taskName,data.deadline)
            })
        }>
            <Form.Group>
                <Form.Label className='FormControlElementLabels'>Tasks Name</Form.Label>
                <Form.Control 
                    required
                    type='text'
            ...
            <Form.Group>
                <Form.Label className='FormControlElementLabels'>Deadline</Form.Label>
                <Form.Control 
                    required
                    type='date'
                    className='FormControlElements'
